...
<br>
v1.70<br>
由于上一个版本重写了太多代码，导致一些样式丢失，现已补回<br>
<br>
v1.69<br>
1.重写遮罩拦截<br>
2.修复内存泄漏<br>
...
v1.65<br>
1.优化细节<br>
2.从今天开始保留旧版本在Old目录里面<br>
<br>
v1.64<br>
优化细节:包括播放按钮错位和日历显示不全和热搜显示错位,以上问题只针对单列模式进行修复,双列模式后续有时间再看看<br>
<br>
v1.63<br>
优化遮罩拦截时间,以防止一直占用CPU,所以深色模式下第一次可能会有一瞬间的灰蒙蒙的遮罩层.<br>
<br>
v1.62<br>
